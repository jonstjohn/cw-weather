...
#import "cw_weatherAppDelegate.h"
#import "CwDailyViewController.h"

@implementation cw_weatherAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	UIViewController *dailyController = [[CwDailyViewController alloc] init];
	UINavigationController *navController = [[UINavigationController alloc] initWithRootViewController: dailyController];
